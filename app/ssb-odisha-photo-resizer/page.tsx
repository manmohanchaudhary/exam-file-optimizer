...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ssb-odisha-photo-resizer',
  },
};

export default function SSBOdishaPhotoResizer() {
  const schema = {
          ...
          <nav className="flex justify-center text-sm text-slate-500 mb-8" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  <span className="mx-2 text-slate-400">/</span>
                  <span className="text-slate-900 font-medium">SSB Odisha Photo Resizer</span>
                </div>
              </li>
            </ol>
          </nav>
