...
export const metadata: Metadata = {
  title: 'RRB NTPC Photo Resizer | Exact Image Size & Dimensions',
  description: 'Resize your photo and signature for the RRB NTPC exam. Get the exact 240x320 pixels and 30KB-70KB file size required for Railway NTPC applications.',
  alternates: {
    canonical: '/rrb-ntpc-photo-resizer',
  },
};

export default function RRBNTPCPhotoResize() {
  return (
    <LandingPageTemplate
      title="RRB NTPC Photo Resizer"
      description="Easily resize and compress your photo for the RRB NTPC exam. Get the exact 240x320 pixels and 30KB-70KB size required for RRB NTPC applications."
      keyword="RRB NTPC photo resizer"
      initialExamId="rrb-ntpc"
      faqs={[
        {
          q: 'What is the RRB NTPC photo size and dimensions?',
          a: 'For the RRB NTPC exam, your photo must be between 30 KB and 70 KB in size. The exact dimensions required are 240(W) x 320(H) pixels.'
        },
        {
          q: 'What is the RRB NTPC signature size?',
          a: 'Your signature for RRB NTPC must be between 30 KB and 70 KB, with minimum dimensions of 140 x 60 pixels.'
        },
        {
          q: 'What background is allowed for RRB NTPC photo?',
          a: 'A plain white or very light-colored background is strictly required for your RRB NTPC passport-size photo.'
        },
        {
          q: 'What format is accepted for RRB NTPC uploads?',
          a: 'Only JPG and JPEG formats are accepted for both photo and signature uploads on the RRB NTPC portal. Documents must be in PDF format.'
        },
        {
          q: 'What is the maximum document size for RRB NTPC?',
    ...
    >
      <section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">RRB NTPC Photo & Signature Requirements</h2>
